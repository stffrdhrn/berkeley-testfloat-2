...
static const bits32 int32P1[ int32NumP1 ] = {
    0x00000000,
    0x00000001,
    0x00000002,
    0x00000004,
...
static const bits32 int32PInfWeightMasks[ int32NumPInfWeightMasks ] = {
    0xFFFFFFFF,
    0x7FFFFFFF,
    0x3FFFFFFF,
    0x1FFFFFFF,
...
static const bits32 int32PInfWeightOffsets[ int32NumPInfWeightMasks ] = {
    0x00000000,
    0xC0000000,
    0xE0000000,
    0xF0000000,
...
static const bits64 int64P1[ int64NumP1 ] = {
...
static const bits64 int64PInfWeightMasks[ int64NumPInfWeightMasks ] = {
    LIT64( 0xFFFFFFFFFFFFFFFF ),
    LIT64( 0x7FFFFFFFFFFFFFFF ),
    LIT64( 0x3FFFFFFFFFFFFFFF ),
    LIT64( 0x1FFFFFFFFFFFFFFF ),
...
static const bits64 int64PInfWeightOffsets[ int64NumPInfWeightMasks ] = {
    LIT64( 0x0000000000000000 ),
    LIT64( 0xC000000000000000 ),
    LIT64( 0xE000000000000000 ),
    LIT64( 0xF000000000000000 ),
...
static const bits32 float32QIn[ float32NumQIn ] = {
...
static const bits32 float32QOut[ float32NumQOut ] = {
    0x00000000,		/* positive, subnormal		*/
    0x00800000,		/* positive, -126		*/
...
static const bits32 float32P1[ float32NumP1 ] = {
    0x00000000,
    0x00000001,
    0x007FFFFF,
    0x007FFFFE
...
static const bits32 float32P2[ float32NumP2 ] = {
    0x00000000,
    0x00000001,
    0x00000002,
    0x00000004,
...
static const bits32 float32QInfWeightMasks[ float32NumQInfWeightMasks ] = {
    0x7F800000,
    0x7F800000,
    0x3F800000,
    0x1F800000,
...
static const bits32 float32QInfWeightOffsets[ float32NumQInfWeightMasks ] = {
    0x00000000,
    0x00000000,
    0x20000000,
    0x30000000,
...
static float32 float32RandomQInfP3( void )
{
    ...
    return
          ( ( (bits32) ( randomUint8() & 1 ) )<<31 )
        | (   (   ( ( (bits32) ( randomUint16() & 0x1FF ) )<<23 )
...
static const bits32 float64QIn[ float64NumQIn ] = {
    0x00000000,		/* positive, subnormal		*/
...
static const bits32 float64QOut[ float64NumQOut ] = {
    0x00000000,		/* positive, subnormal		*/
    0x00100000,		/* positive, -1022		*/
...
static const bits32 float64QInfWeightMasks[ float64NumQInfWeightMasks ] = {
    0x7FF00000,
    0x7FF00000,
    0x3FF00000,
    0x1FF00000,
...
static const bits32 float64QInfWeightOffsets[ float64NumQInfWeightMasks ] = {
    0x00000000,
    0x00000000,
    0x20000000,
    0x30000000,
...
static const bits64 float128QIn[ float128NumQIn ] = {
...
static const bits64 float128QOut[ float128NumQOut ] = {
    LIT64( 0x0000000000000000 ),	/* positive, subnormal		*/
    LIT64( 0x0001000000000000 ),	/* positive, -16382		*/
...
static const bits64 float128QInfWeightMasks[ float128NumQInfWeightMasks ] = {
    LIT64( 0x7FFF000000000000 ),
    LIT64( 0x7FFF000000000000 ),
...
static const bits64 float128QInfWeightOffsets[ float128NumQInfWeightMasks ] = {
    LIT64( 0x0000000000000000 ),
    LIT64( 0x0000000000000000 ),
    LIT64( 0x2000000000000000 ),
...
static float128 float128RandomQInfP3( void )
{
    ...
    z.high =
          ( ( (bits64) ( randomUint8() & 1 ) )<<63 )
        | (   (   ( ( (bits64) randomUint16() )<<48 )
