...
/*----------------------------------------------------------------------------
| Target-specific function for setting the system's IEEE floating-point
...
/*----------------------------------------------------------------------------
| Target-specific function for setting the IEEE rounding precision of
| subsequent double-extended-precision operations performed by the system.
*----------------------------------------------------------------------------*/
